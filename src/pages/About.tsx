...
const About = () => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCounts(prevCounts => {
        ...
        if (newCounts.years < 6) newCounts.years += 1;
        if (newCounts.clients < 150) newCounts.clients += 10;
        if (newCounts.satisfaction < 98) newCounts.satisfaction += 2;
        if (newCounts.professionals < 10) newCounts.professionals += 1;
        
        // Stop the interval when all counts reach their targets
        if (newCounts.years === 6 && newCounts.clients === 150 && 
            newCounts.satisfaction === 98 && newCounts.professionals === 10) {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Sobre Nós | Comando Contabilidade</title>
        <meta name="description" content="Fundado em 2017, o Comando Contabilidade oferece serviços contábeis com excelência e atendimento humanizado. Conheça nossa história e equipe." />
      </Helmet>
      ...
      <main>
        <section className="pt-24 pb-12 md:pt-32 md:pb-16 bg-gradient-to-b from-primary-50 to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <span className={`inline-block py-1.5 px-4 rounded-full text-sm font-semibold bg-primary-100 text-primary-700 mb-4 opacity-0 ${isVisible ? 'animate-fadeIn' : ''}`}>
                Sobre Nós
              </span>
              <h1 className={`text-3xl md:text-5xl font-bold mb-4 leading-tight opacity-0 ${isVisible ? 'animate-slideDown' : ''}`}>
                Nossa <span className="text-primary-700">história</span> e valores
              </h1>
        ...
        <section className="py-12 md:py-16 bg-primary-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-10">
              <span className="inline-block py-1.5 px-4 rounded-full text-sm font-semibold bg-primary-100 text-primary-700 mb-3">
                Nossa Jornada
              </span>
              <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                Como nos <span className="text-primary-700">tornamos</span> quem somos
              </h2>
              ...
              <div className="space-y-10">
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  <div className="flex-1 md:text-right md:pr-10 mb-6 md:mb-0">
                    <div className="bg-white p-5 rounded-lg shadow-sm">
                      <h3 className="text-xl font-bold text-primary-700 mb-2">2017</h3>
                  ...
                  <div className="w-10 h-10 rounded-full bg-primary-600 border-4 border-white shadow-md z-10 md:absolute md:left-1/2 md:transform md:-translate-x-1/2 flex items-center justify-center text-white">
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="flex-1 md:pl-10 md:text-left">
                    <div className="bg-white p-5 rounded-lg shadow-sm">
                      <h3 className="text-xl font-bold text-primary-700 mb-2">2019</h3>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  <div className="flex-1 md:text-right md:pr-10 mb-6 md:mb-0">
                    <div className="bg-white p-5 rounded-lg shadow-sm">
                      <h3 className="text-xl font-bold text-primary-700 mb-2">2021</h3>
                ...
                <div className="relative flex flex-col md:flex-row items-center">
                  ...
                  <div className="flex-1 md:pl-10 md:text-left">
                    <div className="bg-white p-5 rounded-lg shadow-sm">
                      <h3 className="text-xl font-bold text-primary-700 mb-2">Presente</h3>
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                Resultados que demonstram nosso <span className="text-primary-700">compromisso</span>
              </h2>
              <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              <div className="bg-primary-50 p-6 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                <div className="w-14 h-14 mx-auto mb-4 bg-primary-100 rounded-full flex items-center justify-center">
                  <Clock className="w-6 h-6 text-primary-600" />
                </div>
                <h3 className="text-3xl font-bold text-primary-700 mb-2">{counts.years}</h3>
              ...
              <div className="bg-primary-50 p-6 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                ...
                <h3 className="text-3xl font-bold text-primary-700 mb-2">{counts.clients}+</h3>
              ...
              <div className="bg-primary-50 p-6 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                ...
                <h3 className="text-3xl font-bold text-primary-700 mb-2">{counts.satisfaction}%</h3>
              ...
              <div className="bg-primary-50 p-6 rounded-xl shadow-sm text-center transform transition-transform hover:-translate-y-1 hover:shadow-md">
                ...
                <h3 className="text-3xl font-bold text-primary-700 mb-2">{counts.professionals}</h3>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-primary-50 to-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-tight">
                Pronto para simplificar a <span className="text-primary-700">contabilidade</span> da sua empresa?
              </h2>
